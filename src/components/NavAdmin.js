        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex items-center justify-between h-16">
            <div class="flex items-center">
              ...
              <a href="/"><img class="w-[200px]" src="https://mcdn.nhanh.vn/store/16762/logo_1637162795_logo%20png-03.png" alt="Workflow"></a>
              </div>
              <div class="hidden md:block">
                <div class="ml-10 flex items-baseline space-x-4">
                  <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                  <a href="/admin/dashboard" class="bg-gray-900 text-white decoration-white no-underline px-3 py-2 rounded-md text-sm font-medium" aria-current="page">Dashboard</a>
    
                  <a href="/admin/news" class="text-gray-300 hover:bg-gray-700 decoration-white no-underline hover:text-white px-3 py-2 rounded-md text-sm font-medium">News</a>
